...
For me, programming is much more than just a job: it's a language for building. It is a structured way to organize thoughts, solve problems and design experiences, bringing to life concepts that were just sketches in the mind.

My work spans software development, automation pipelines and data integration, I am committed to delivering software that genuinely provides value. Not just code that executes, but meaningful projects that optimize workflows, save time, and show empathy for the end-user.
